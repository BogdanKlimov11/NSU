...
void MeshWidget::initializeGL() {
    ...
    objectArray.emplace_back(new Object("MeshCube", ":/mesh_cube.obj", 1.5f));
    objectArray.emplace_back(new Object("MeshHouse", ":/mesh_house.obj", 0.5f));
    objectArray.emplace_back(new Object("MeshSphere", ":/mesh_sphere.obj", 2.0f));
...
void MeshWidget::paintGL() {
    ...
    if (currentObjectIndex < objectArray.size()) {
        auto obj = objectArray[currentObjectIndex];
        if (obj->isValid()) {
            QMatrix4x4 model;
