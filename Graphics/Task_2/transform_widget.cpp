...
void SceneWidget::set_split_parameter(size_t parameter) {
...
void SceneWidget::set_morphing_parameter(float parameter) {
...
void SceneWidget::update_geometry() { // Обновление геометрических данных
