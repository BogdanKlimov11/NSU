...
void RoadMaterial::setZOffset(float zOffset) {
    this->zOffset = zOffset / 100.0f;
}
...
void RoadMaterial::initUniforms() {
    ...
    zOffsetUniform = program->uniformLocation("zOffset");
}
...
void RoadMaterial::setUniforms() const {
    ...
    program->setUniformValue(zOffsetUniform, zOffset);
}
