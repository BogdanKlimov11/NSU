...
void test_two_elements() {
    int arr1[] = {2, 1};
    int* sorted1 = bubble_sort(arr1, 2);
    ...
    int arr2[] = {1, 2};
    int* sorted2 = bubble_sort(arr2, 2);
...
void test_even_length() {
    int arr1[] = {4, 2, 3, 1};
    int* sorted1 = bubble_sort(arr1, 4);
    ...
    int arr2[] = {1, 2, 3, 4};
    int* sorted2 = bubble_sort(arr2, 4);
...
void test_odd_length() {
    int arr1[] = {3, 1, 4, 1, 5};
    int* sorted1 = bubble_sort(arr1, 5);
    ...
    assert(is_sorted(sortedmissed sorted1 != NULL && "Odd length array should return non-NULL");
    assert(is_sorted(sorted1, 5) && "Odd length array should be sorted");
    free(sorted1);

    int arr2[] = {1, 2, 3, 4, 5};
    int* sorted2 = bubble_sort(arr2, 5);
...
void test_same_elements() {
    ...
    int arr2[] = {1, 1, 1};
    int* sorted2 = bubble_sort(arr2, 3);
