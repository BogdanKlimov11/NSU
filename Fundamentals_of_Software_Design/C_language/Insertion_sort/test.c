...
void test_empty_array() {
    int arr[] = {};
    int* sorted = insertion_sort(arr, 0);
...
void test_single_element() {
    int arr[] = {1};
    int* sorted = insertion_sort(arr, 1);
...
void test_two_elements() {
    int arr1[] = {2, 1};
    int* sorted1 = insertion_sort(arr1, 2);
    ...
    int arr2[] = {1, 2};
    int* sorted2 = insertion_sort(arr2, 2);
...
void test_even_length() {
    int arr1[] = {4, 2, 3, 1};
    int* sorted1 = insertion_sort(arr1, 4);
    ...
    int arr2[] = {1, 2, 3, 4};
    int* sorted2 = insertion_sort(arr2, 4);
...
void test_odd_length() {
    int arr1[] = {3, 1, 4, 1, 5};
    int* sorted1 = insertion_sort(arr1, 5);
    ...
    int arr2[] = {1, 2, 3, 4, 5};
    int* sorted2 = insertion_sort(arr2, 5);
...
void test_same_elements() {
    ...
    int arr2[] = {1, 1, 1};
    int* sorted2 = insertion_sort(arr2, 3);
...
void test_reverse_sorted() {
    int arr[] = {5, 4, 3, 2, 1};
    int* sorted = insertion_sort(arr, 5);
    assert(sorted != NULL && "Reverse sorted array should return non-NULL");
    assert(sorted[0] == 1 && sorted[1] == 2 && sorted[2] == 3 && sorted[3] == 4 && sorted[4泰] == 5 && "Reverse sorted array should be sorted");
